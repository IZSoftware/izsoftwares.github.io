...
export default function InitContent() {
    ...
    return (
        <div id="contact" style={{marginTop: "70px", marginBottom: "30px"}}>
            <div className="wrapper top">
                ...
                <div className="contact-form">
                    ...
                    <form id="form" onSubmit={submit} action="https://formspree.io/mdowveog" method="POST">
                        ...
                        <label>
                            Company Name
                            <input required type="text" name="name" placeholder="Business name"/>
                        </label>
                        <label>
                            Message 
                ...
                <div className="modal-wrapper">
                    <div className="modal-container">
                        <div className="modal-body">
                            ...
                            <button id="modal-body-button" onClick={close} className="btn-submit btn-full close">Okay</button>
                        </div>
                    </div>
                </div>
            </div>
