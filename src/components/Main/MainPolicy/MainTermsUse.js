                        ...
                        <Grid container direction="row" justifyContent="center" alignItems="center">
                            <Grid item xs={12} sm={12} md={10}>
                                <Typography variant='body1' paragraph="true">
                                    ...
                                    operated by Evolv IZSoftwares Group ("The Company", "us", "we", or "our").
                                    <br /> <br />
                            ...
                            <Grid item xs={12} sm={12} md={10}>
                                ...
                                <br /><br />
                                    By using any Third Party Content, You may leave this Website and be directed to an external website, or to a website maintained by an entity other than the Company. 
                                    ...
                                    <br />The Company makes no warranty or representation regarding, and does not endorse, any linked Websites or the information appearing thereon or any of the products or services described thereon
                                </Typography>
                            </Grid>
