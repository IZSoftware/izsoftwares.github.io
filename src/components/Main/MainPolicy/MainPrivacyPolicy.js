                        ...
                        <Grid container direction="row" justifyContent="center" alignItems="center">
                            ...
                            <Grid item xs={12} sm={12} md={10}>
                                ...
                                <Typography variant='subtitle1' paragraph="true">
                                    <i>Last Updated: January 05, 2024</i>
                                </Typography>
                                <br />
                                This privacy statement explains what personal data <b style={{color: '#004485'}}>Evolv IZSoftwares Group</b> collects from you and how we use that data.                                
                            </Grid>
                        </Grid>
                        <Grid container direction="row" justifyContent="center" alignItems="center">
                            <Grid item xs={12} sm={12} md={10}>
                            ...
                            <Grid item xs={12} sm={12} md={10}>
                                ...
                                <Typography variant='body1' paragraph="true">
                                    We are <b style={{color: '#004485'}}>Evolv IZSoftwares Group</b>, a Kenya headquartered provider of Custom Software Development Services, eGovernment Solutions, UI/UX Design, Legacy Modernization, ConnectSphere services and Digital Transformation with IT professionals located internationally. 
                            ...
                            <Grid item xs={12} sm={12} md={10}>
                                <br /> <br />
                                <Typography variant='body1' paragraph="true">
                                    <b style={{color: '#004485'}}>Evolv IZSoftwares Group</b> collects data to provide you with direct feedback in respect of our services. You provide some of this data directly, such as when you fill in the 
