...
const services = [
  {
    ...
    description:
      'We help organizations adopt a proactive cybersecurity strategy that includes robust threat detection and incident response mechanisms and continuous evolution of their cyber defenses.',
    bullets: [
  ...
  {
    key: 'it-security-operations',
    label: 'IT Security Operations',
    title: 'IT Security Operations',
    description:
      'We provide end-to-end managed security operations to keep your infrastructure protected 24/7, with rapid incident detection, response, and remediation capabilities.',
    bullets: [
  ...
  },
  {
    ...
    description:
      'We help organizations achieve and maintain compliance with global and industry-specific regulations through thorough assessments and tailored remediation strategies.',
    bullets: [
...
export default function CybersecurityServices() {
  const [active, setActive] = useState('security-consulting');
