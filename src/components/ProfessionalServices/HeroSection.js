...
const heroImageUrl = '/it-solutions-for-professional-services-cover-update.svg';
                ...
                >
                  <Grid item xs={12} md={6}>
                    <Box sx={{ 
                      ...
                      >
                        Since 2022, IZSoftwares has been helping professional services companies launch digital customer service channels and build tailored software solutions for business process management.
                      </Typography>
