      ...
      <Container maxWidth={false} sx={{ px: { xs: 5, sm: 3, md: 0 } }}>
        <Grid container spacing={6} justifyContent="center">
          <Grid item xs={12} md={9.5}>
            ...
            >
              Financial IT services are aimed to help BFSI companies create and operate tailored digital solutions smoothly, cost-effectively, and with minimal effort. Addressing these aspects, ScienceSoft offers all-encompassing services — from consulting and software engineering to cybersecurity and IT support.
            </Typography>
